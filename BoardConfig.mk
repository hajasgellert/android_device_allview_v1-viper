...
DEVICE_FOLDER := device/allview/v1-viper

-include vendor/allview/v1-viper/BoardConfigVendor.mk
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/allview/v1-viper/bluetooth
...
# EGL settings
BOARD_EGL_CFG := device/allview/v1-viper/egl.cfg
...
# recovery-mtk
RECOVERY_NAME := ALLViEW V1_ViPER C.W.M.BASED-RECOVERY
...
# telephony
BOARD_RIL_CLASS := ../../../device/allview/v1-viper/ril/
